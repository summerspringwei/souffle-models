...
sudo /usr/local/cuda/bin//ncu --mode=launch --target-processes all /home/xiachunwei/Software/anaconda3/bin/python3 mindspore_lstm.py

# sudo /usr/local/cuda/bin//ncu --mode=attach --hostname 127.0.0.1 --set full -o mindspore_lstm -f
