...
// block (4, 1, 1),(32, 1, 1)
extern "C" __global__ void __launch_bounds__(32) MMoE_experts_1_100_16_8_2(
...
// block (1, 1, 1),(16, 1, 1)
extern "C" __global__ void __launch_bounds__(16) MMoE_gates_1_100_16_8_2(float* __restrict__ MMoE_gates_placeholder, float* __restrict__ expert_gate_weight, float* __restrict__ MMoE_gates_compute, float* __restrict__ expert_gate_bias) {
  float compute1[1];
...
// block (1, 1, 1),(16, 1, 1)
extern "C" __global__ void __launch_bounds__(16) MMoE_gates_activation_1_100_16_8_2(float* __restrict__ MMoE_gates_activations_compute, float* __restrict__ gate_bias, float* __restrict__ MMoE_gates_activations_placeholder) {
...
// block (1, 1, 1),(2, 1, 1)
extern "C" __global__ void __launch_bounds__(2) MMoE_gates_sum_1_100_16_8_2(float* __restrict__ MMoE_gates_sum_compute, float* __restrict__ gate_bias) {
  MMoE_gates_sum_compute[(((int)threadIdx.x))] = 0.000000e+00f;
  for (int rk = 0; rk < 8; ++rk) {
    MMoE_gates_sum_compute[(((int)threadIdx.x))] = (MMoE_gates_sum_compute[(((int)threadIdx.x))] + __expf(gate_bias[(((rk * 2) + ((int)threadIdx.x)))]));
  }
}


// block (1, 1, 1),(32, 1, 1)
extern "C" __global__ void __launch_bounds__(32) MMoE_select_experts_1_100_16_8_2(float* __restrict__ MMoE_select_experts, float* __restrict__ expert_activation, float* __restrict__ gate_activation) {
...
// block (6, 1, 1),(24, 1, 1)
extern "C" __global__ void __launch_bounds__(24) MMoE_fused_experts_gates_1_100_16_8_2(float* __restrict__ MMoE_fused_experts_gates, float* __restrict__ fused_expert_gate_weight, float* __restrict__ MMoE_fused_experts_gates_compute, float* __restrict__ fused_expert_gate_bias) {
